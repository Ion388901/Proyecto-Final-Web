...
<div class="row">
    <div class="col">
        <a class="btn btn-success btn-sm" href="<?php echo e(route('npanel.productos.index', ['order' => 'desc'])); ?>">Ordena de forma descendente</a>
        <a class="btn btn-success btn-sm" href="<?php echo e(route('npanel.productos.index', ['order' => 'asc'])); ?>">Ordena de forma ascendente</a>
    </div>
</div>
<div class="row">
    <div class="col">
