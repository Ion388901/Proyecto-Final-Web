...
<form class="form-signin" method="POST" action="<?php echo e(route('npanel.user.create')); ?>">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('npanel.layouts.unregistered', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>