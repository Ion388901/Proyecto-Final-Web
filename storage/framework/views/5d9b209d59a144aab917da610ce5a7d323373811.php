    ...
    <div class="col">
        <?php if(!$data['colecciones']->isEmpty()): ?>
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $data['colecciones']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coleccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                            ...
                            <td>
                                <?php if(count($coleccion->producto) > 0): ?>
                                <?php echo e($coleccion->producto->nombre); ?>
